...
<div><main class="indexPage leftContent">
<%@ include file="/WEB-INF/searchSuggestion.jspf" %>
<c:forEach items="${articles}" var="art" ><c:out escapeXml="false" value="${art.summary}"/>
</c:forEach><%@ include file="/WEB-INF/pagenation.jspf" %>

...
@NamedQueries({
    ...
    @NamedQuery(name = "Filemetadata.searchByType", query = "SELECT" + Fileupload.METADATA_CONSTRUCTOR + "FROM Fileupload f WHERE f.mimetype like CONCAT('%',:term,'%') ORDER BY f.filename")})
